...
class washing_machine:
    ...
    wash_time['short'] = fuzz.trapmf(wash_time.universe, [5, 10, 15, 20])
    wash_time['medium'] = fuzz.trapmf(wash_time.universe, [15, 25, 35, 40])
    wash_time['long'] = fuzz.trapmf(wash_time.universe, [30, 40, 50, 60])
    wash_time['VeryLong'] = fuzz.trapmf(wash_time.universe, [50, 60, 60, 60])
