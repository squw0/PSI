...
class washing_machine:
    ...
    wash_time['very_short'] = fuzz.trimf(wash_time.universe, [40, 48, 420])
    wash_time['short'] = fuzz.trimf(wash_time.universe, [40, 42, 44])
    wash_time['medium'] = fuzz.trimf(wash_time.universe, [12, 220, 410])
    wash_time['long'] = fuzz.trimf(wash_time.universe, [2, 4, 60])
    wash_time['VeryLong'] = fuzz.trimf(wash_time.universe, [10, 64, 620])
