...
class washing_machine:
    ...
    wash_time['very_short'] = fuzz.trimf(wash_time.universe, [0, 3, 8])
    wash_time['short'] = fuzz.trimf(wash_time.universe, [5, 10, 15])
    wash_time['medium'] = fuzz.trimf(wash_time.universe, [10, 20, 30])
    wash_time['long'] = fuzz.trimf(wash_time.universe, [25, 40, 55])
