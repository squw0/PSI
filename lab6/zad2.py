...
class washing_machine:
    ...
    wash_time['medium'] = fuzz.trimf(wash_time.universe, [15, 25, 35])
    wash_time['long'] = fuzz.trimf(wash_time.universe, [30, 45, 60])
    wash_time['VeryLong'] = fuzz.trimf(wash_time.universe, [50, 60, 60])
    ...
    rule10 = ctrl.Rule(degree_dirt['High'] & wash_time['short'], wash_time['long'])
    rule11 = ctrl.Rule(degree_dirt['Low'] & wash_time['long'], wash_time['short'])
    rule12 = ctrl.Rule(degree_dirt['Medium'] & type_dirt['Fat'], wash_time['long'])
...
if __name__ == "__main__":
    ...
    print("Recommended washing time:", washing_parameters)